...
// source: core/infra/nats/nats.proto
...
func (*RPCRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c0e112c3340c89c9, []int{0}
}
...
func (*RPCResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c0e112c3340c89c9, []int{1}
}
...
func init() { proto.RegisterFile("core/infra/nats/nats.proto", fileDescriptor_c0e112c3340c89c9) }

var fileDescriptor_c0e112c3340c89c9 = []byte{
	// 196 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *RPCResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Err) > 0 {
		i -= len(m.Err)
		copy(dAtA[i:], m.Err)
		i = encodeVarintNats(dAtA, i, uint64(len(m.Err)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Data) > 0 {
...
func skipNats(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupNats
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupNats = fmt.Errorf("proto: unexpected end of group")
)
