...
var fileDescriptor_c0d7f795a8914964 = []byte{
	...
	,
}
...
func (m *Package) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Module) > 0 {
		...
		i = encodeVarintPackage(dAtA, i, uint64(len(m.Module)))
		i--
		dAtA[i] = 0x12
	}
	if m.ServerID != 0 {
